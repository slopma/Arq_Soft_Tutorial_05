...
Map.of("id", "1", "name", "TV", "description", "Best TV", "price", "1000"),

Map.of("id", "2", "name", "iPhone", "description", "Best iPhone" , "price", "1000"),

Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast" , "price", "1000"),

Map.of("id", "4", "name", "Glasses", "description", "Best Glasses" , "price", "1000")
